...
import robson.exception.*;
import robson.language.Instruction;
import robson.language.operation.arithmetical.*;
import robson.language.operation.logical.*;
import robson.language.operation.relational.*;
import robson.language.statement.*;
import robson.language.storage.*;
import robson.language.util.*;
...
public class Robson {
    ...
    public void fromJSON(String filename) throws IOException, InvalidProgramException {
    ...
    public double wykonaj() throws ProgramProcessingException {
